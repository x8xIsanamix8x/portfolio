...
// Define un array de habilidades
  ...
  return (
    ...
    <div id='about' className='max-w-screen-2xl flex flex-col xl:flex-row xl:justify-between items-center xl:items-start gap-12 w-full py-16 px-12'>
      <div className='flex-1 flex flex-col gap-4 '>

        <div className='mx-5 mb-8'>
          <h1 className='text-4xl font-bold text-start text-[#001b5e] inline border-b-4 border-[#001b5e]'>About me</h1>
        </div>
        ...
        <p className='flex mt-1 mb-8 mx-5 text-lg sm:mb-12 pt-4 items-justify text-justify'>
          ...
          several years of a cereer in the web development world, I've had the privilege to work across various areas,
          from UI design to the implementation of robust technical solutions.
        </p>

      </div>

      <div className='grid mx-5 grid-cols-3 grid-rows sm:grid-cols-5 lg:grid-cols gap-1 lg:mt-20 auto-rows-max'>
