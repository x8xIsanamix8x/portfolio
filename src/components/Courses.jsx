...
const coursesData = [
    { id: 1, title: 'Complete Web & Mobile Designe in 2023: UI/UX, Figma, +more.', year: 2023, provider: 'Udemy' },
    { id: 2, title: 'Curso de Venta B2B - Ventas de Negocio a Negocio.', year: 2023, provider: 'Udemy' },
    { id: 3, title: 'Diseño UX: experiencia de usuario UX/UI + Figma 2023.', year: 2023, provider: 'Udemy' },
    { id: 4, title: 'React: De cero a experto ( Hooks y MERN ).', year: 2023, provider: 'Udemy' },
    { id: 5, title: 'React Native - Crea aplicaciones para Android y iOS con React.', year: 2023, provider: 'Udemy' },
    { id: 6, title: 'React Native: Aplicaciones nativas para iOS y Android.', year: 2023, provider: 'Udemy' },
    { id: 7, title: 'SCRUM 2023: Gestión Ágil de Proyectos con SCRUM desde cero.', year: 2023, provider: 'Udemy' },
    { id: 8, title: 'Desarrollo Web Completo con HTML5, CSS3. JS, AJAX, PHP y MySQL.', year: 2023, provider: 'Udemy' },
    { id: 9, title: 'Curso Introducción al Ethical Hacking.', year: 2018, provider: 'ISEIT' },
    { id: 10, title: 'Redacción en la Web 2.0', year: 2016, provider: 'CONATEL' },
    { id: 11, title: 'GNU/Linux Avanzado', year: 2016, provider: 'CONATEL' },
    { id: 12, title: 'GNU/Linux Intermedio', year: 2015, provider: 'CNTI' },
    { id: 13, title: 'GNU/Linux Basico', year: 2015, provider: 'CNTI' },
];
    ...
    <div id='courses' className='max-w-[1040px] m-auto md:pl-20 p-4 py-16'>
        ...
        <ol class="py-8 items-center sm:flex">
            {coursesData.map((item) => (
                <li class="relative mb-6 sm:mb-0" key={ item.id }>
                    { item.id <= 4 && (
                        <>
                            ...
                            <div class="mt-3 sm:pr-8">
                                ...
                                <time class="block mb-2 mt-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">{ item.year }</time>
                                <p class="text-base font-normal text-gray-500 dark:text-gray-400">{ item.provider }.</p>
                            </div>
                        </>  
                    )}
                </li>
                ...
                <li class="relative mb-6 sm:mb-0" key={ item.id }>
                    { (item.id > 4 && item.id <= 8) && (
                        <>
                            ...
                            <div class="mt-3 sm:pr-8">
                                <h3 class="text-md font-semibold text-gray-900 dark:text-black">{ item.title }</h3>
                                <time class="block mb-2 mt-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">{ item.year }</time>
                                <p class="text-base font-normal text-gray-500 dark:text-gray-400">{ item.provider }.</p>
                            </div>
                        </>  
