        ...
        <ol class="py-8 items-center sm:flex">
            <li class="relative mb-6 sm:mb-0">
                ...
                <div class="mt-3 sm:pr-8">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-black">Flowbite Library v1.0.0</h3>
            ...
            <li class="relative mb-6 sm:mb-0">
                ...
                <div class="mt-3 sm:pr-8">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-black">Flowbite Library v1.2.0</h3>
            ...
            <li class="relative mb-6 sm:mb-0">
                ...
                <div class="mt-3 sm:pr-8">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-black">Flowbite Library v1.3.0</h3>
